package com.fadhlalhafizh.storyapplication.data.local.database
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val responseData = apiService.getStories(token = "Bearer $token", page, state.config.pageSize).listStory
